...
const messages = {
  fr: {
    ...
    actions: { logout: 'Déconnexion', recent: 'Dernières factures', viewAll: 'Voir tout' },
  ...
  en: {
    ...
    actions: { logout: 'Sign out', recent: 'Recent invoices', viewAll: 'View all' },
  ...
  es: {
    ...
    actions: { logout: 'Cerrar sesión', recent: 'Facturas recientes', viewAll: 'Ver todo' },
  ...
  ar: {
    ...
    actions: { logout: 'تسجيل الخروج', recent: 'الفواتير الأخيرة', viewAll: 'عرض الكل' },
